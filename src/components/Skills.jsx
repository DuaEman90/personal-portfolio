...
function Skills() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute left-[-220px] top-[20%] h-[450px] w-[450px] rounded-full bg-cyan-500/[0.045] blur-[150px]" />

      <div className="pointer-events-none absolute bottom-[-180px] right-[-180px] h-[450px] w-[450px] rounded-full bg-blue-600/[0.05] blur-[150px]" />

      <div className="pointer-events-none absolute left-[45%] top-[-200px] h-[350px] w-[500px] rounded-full bg-cyan-400/[0.025] blur-[130px]" />
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="mb-20 text-center">
          ...
          <h2 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl">
            Tools & <span className="text-cyan-400">More</span>
          </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative flex items-center gap-5">
                    ...
                    <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl border border-cyan-400/15 bg-cyan-400/[0.05] text-cyan-400 shadow-[0_0_25px_rgba(34,211,238,0.07)] transition-all duration-500 group-hover:scale-105 group-hover:border-cyan-400/30">
        ...
        <div className="relative mt-20">
          ...
          <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.025] px-7 py-9 shadow-[0_20px_70px_rgba(0,0,0,0.25)] backdrop-blur-xl sm:px-10 sm:py-11">
            ...
            <div className="pointer-events-none absolute -left-24 bottom-[-80px] h-48 w-48 rounded-full bg-cyan-400/[0.08] blur-[70px]" />

            <div className="pointer-events-none absolute -right-24 top-[-80px] h-48 w-48 rounded-full bg-blue-500/[0.07] blur-[70px]" />
